	...
	<div style="" id="allLinks">
		...
		{%- endfor %}
															...
															<div id="socials">
																...
																<a class="extraLinks" class="n02" href="https://www.twitter.com/puppeypawbs" role="button" style="color: #bbcc97; padding-top: 4px;">
																	<svg width="40" height="40" viewBox="0 0 40 40" fill="currentColor">
																...
																<span class="link-bar-separator">|</span>
																<a class="extraLinks" class="n03" href="https://patreon.com/HappyTrailsComic" role="button" style="color: #bbcc97; padding-top: 4px;">
																	<svg width="40" height="40" viewBox="0 0 40 40" fill="currentColor">
																...
																<span class="link-bar-separator">|</span>
																<a class="extraLinks" href="https://www.furaffinity.net/user/puppeypawbs/" role="button" style="color: #bbcc97; padding-top: 4px;" class="n04">
																	<svg width="40" height="40" viewBox="0 0 40 40" fill="currentColor">
